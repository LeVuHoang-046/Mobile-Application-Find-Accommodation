...
import { Confirmed, Diposited, Overdue, WaitConfirm } from './page';

const ManageScheduleScreen: React.FC<PerformanceNavigationHOC> = ({
  navigateFinish,
}) => {
...
export const ManageSchedule = performanceNavigation(
