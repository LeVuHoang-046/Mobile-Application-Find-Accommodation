...
import { BottomSheetPickerServiceProps, BottomSheetPickerServiceRef } from './BottomSheetPickerService.type';
import { HEIGHT_ITEM_PICKER, initItemPicker, MAX_HEIGHT_MODAL, PADDING_BOTTOM_LIST } from '@constants';
import { scaler } from '@themes';
import { searchAndSortFilter, sortBetweenTitlePicker } from '@utils';
import { ButtonPicker } from './ButtonPicker';
import { ButtonSelectBottomSheet, ButtonSelectServiceBottomSheet } from '@component/button';
...
import { LoadingComponent } from '@component/loading';
  ...
  export const BottomSheetPickerService: ForwardRefComponent<
    BottomSheetPickerServiceRef,
    BottomSheetPickerServiceProps
  > = forwardRef(
    (
      {
        onChange,
      ...
      const DATA = useMemo(() => {
        if (!searchLocal) {
          return sortBetweenTitlePicker(list);
        }
        return searchAndSortFilter(list, search);
      ...
      return (
        <>
          <ButtonSelectServiceBottomSheet
            placeholder={title}
