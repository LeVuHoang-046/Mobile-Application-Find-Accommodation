import {BottomSheetModalAppRef} from '@component/BottomSheetModalApp';
...
import {
  BottomSheetPickerSingleAppProps,
  BottomSheetPickerSingleAppRef,
} from './BottomSheetPickerSingleApp.type';
import {ButtonPickerSingle} from './ButtonPickerSingle';

export const BottomSheetPickerSingleApp: ForwardRefComponent<
  BottomSheetPickerSingleAppRef,
  BottomSheetPickerSingleAppProps
> = forwardRef(
  (
    ...
    return (
      <>
        <Box>
          {/* <Box p={scaler(5)} mb={scaler(10)} color={'pink'}>
            <TextApp
              // numberOfLines={1}
